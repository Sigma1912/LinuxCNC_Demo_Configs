...
try: # Expect files in working directory
    ...
    print(detail)
    raise SystemExit("example-gui requires stl files in working directory")

for setting in sys.argv[1:]: exec(setting)

c = hal.component("example-gui")
# axis_x
...
myhud.add_pin("Xx: {:8.3f}","example-gui.twp_xx")
myhud.add_pin("Xy: {:8.3f}","example-gui.twp_xy")
myhud.add_pin("Xz: {:8.3f}","example-gui.twp_xz")
myhud.add_txt("")
myhud.add_txt("TWP-Orientation Vector Z:")
myhud.add_pin("Zx: {:8.3f}","example-gui.twp_zx")
myhud.add_pin("Zy: {:8.3f}","example-gui.twp_zy")
myhud.add_pin("Zz: {:8.3f}","example-gui.twp_zz")
myhud.add_txt("")
