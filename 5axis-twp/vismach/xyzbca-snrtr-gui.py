...
# This is a machine simulation for the 'xyzbca-snrtr' simulation config in linuxcnc
...
try: # Expect files in working directory
    ...
    print(detail)
    raise SystemExit("gen-xyzbca-snrtr-gui requires stl files in working directory")
'''

for setting in sys.argv[1:]: exec(setting)

c = hal.component("xyzbca-snrtr-gui")
# axis_x
...
myhud.add_pin("Xx: {:8.3f}","xyzbca-snrtr-gui.twp_xx",[1,2,3])
myhud.add_pin("Xy: {:8.3f}","xyzbca-snrtr-gui.twp_xy",[1,2,3])
myhud.add_pin("Xz: {:8.3f}","xyzbca-snrtr-gui.twp_xz",[1,2,3])
myhud.add_txt("",[1,2,3])
myhud.add_txt("TWP-Orientation Vector Z:",[1,2,3])
myhud.add_pin("Zx: {:8.3f}","xyzbca-snrtr-gui.twp_zx",[1,2,3])
myhud.add_pin("Zy: {:8.3f}","xyzbca-snrtr-gui.twp_zy",[1,2,3])
myhud.add_pin("Zz: {:8.3f}","xyzbca-snrtr-gui.twp_zz",[1,2,3])
myhud.add_txt("",[1,2,3])
myhud.show_tags_in_pin("xyzbca-snrtr-gui.twp_status")
#/hud
