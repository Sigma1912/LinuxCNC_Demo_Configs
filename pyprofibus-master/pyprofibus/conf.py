...
from .gsd.interp import GsdInterp
from .gsd.parser import GsdError
from .util import *

from .phy_serial import *
...
class PbConf(object):
	...
	class _SlaveConf(object):
		...
		def makeDpSlaveDesc(self):
			...
			"""
			from .dp_master import DpSlaveDesc
	...
	def makePhy(self):
		...
		if phyType == "serial":
			#from ..phy_serial import *
			phyClass = CpPhySerial
			extraKwArgs = {}
		elif phyType in {"dummyslave", "dummy_slave", "dummy-slave"}:
			#from ..phy_dummy import *
			phyClass = phy_dummy.CpPhyDummySlave
			extraKwArgs = {
			...
			#from ..phy_fpga import *
			phyClass = phy_fpga.CpPhyFPGA
			extraKwArgs = {}
		else:
	...
	def makeDPM(self, phy=None):
		...
		from .dp_master import DPM1, DPM2
